<?php
//dd($segment_data);
if($segment_data['type'] == 'return') {
    $segments = $segment_data['outbound']['flightSegments'];
    $segments = array_merge($segments,$segment_data['inbound']['flightSegments']);
}else {
    $segments = $segment_data['flightSegments'];
}
$message = '
