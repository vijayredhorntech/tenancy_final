                         ...
                         <div class="w-full grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-4 mt-4">
                                    ...
                                    @endif
                                      ...
                                      @if(in_array('LinkedIn', $permission))
                                        <!-- zip code -->
                                        <div class="w-full relative group flex flex-col gap-1">
                                                    <label for="linkedIn" class="font-semibold text-ternary/90 text-sm">Twitter</label>
                                                    <div class="w-full relative flex items-center gap-2">
                                    ...
                                    @endif
                                      ...
                                      @if(in_array('Other Social Media Accounts', $permission))
                                        <!-- zip code -->
                                        <div class="w-full relative group flex flex-col gap-1">
                                                    <label for="othersocialmediaaccounts" class="font-semibold text-ternary/90 text-sm">Twitter</label>
                                                    <div class="w-full relative flex items-center gap-2">
                                    ...
                                    @endif
                                      ...
                                      @if(in_array('Blog URLs', $permission))
                                        <!-- zip code -->
                                        <div class="w-full relative group flex flex-col gap-1">
                                                    <label for="blogurl" class="font-semibold text-ternary/90 text-sm">Twitter</label>
                                                    <div class="w-full relative flex items-center gap-2">
