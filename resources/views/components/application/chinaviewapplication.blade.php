            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden section-container" data-section="personal">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Last Name -->
                        <div class="w-full relative group flex flex-col gap-1">
                                <label for="last_name" class="font-semibold text-ternary/90 text-sm">Given Name<span class="text-danger">*</span></label>
                                <div class="w-full relative">
                        ...
                        @if(in_array('Preview Name', $permission))
                            ...
                            <!-- Previous Name -->
                            <div class="w-full relative group flex flex-col gap-1">
                                <label for="previous_name" class="font-semibold text-ternary/90 text-sm">Former Name (if any)</label>
                                <div class="w-full relative">
                                    ...
                                    <div class="p-6">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                              ...
                                              @if(in_array('Passport Type', $permission))
                                                    <div class="w-full relative group flex flex-col gap-1">
                                                            <label for="passport_type" class="font-semibold text-ternary/90 text-sm">Type of passport *</label>
                                                            <div class="w-full relative">
                ...
                @if(in_array('visa_history_background', $alreadySelect))
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="w-full relative group flex flex-col gap-1">
                                        <label for="type_of_visa" class="font-semibold text-ternary/90 text-sm">Visa Validity</label>

                                        <div class="w-full relative">
                                            <span id="type_of_visa"
                                                class="w-full block pl-2 pr-8 py-1 rounded-[3px] rounded-tr-[8px] border border-red-400 text-ternary/90 focus:outline-none placeholder-ternary/70 transition ease-in duration-200">
                                                {{ $bookingData->visasubtype->validity}}
                                            </span>
                                            <i class="fa fa-map-marker-alt absolute right-3 top-[50%] translate-y-[-50%] text-sm text-red-400"></i>
                                        </div>
                                    </div>
                                   ...
                                   @if(in_array('Duration of Stay', $permission))
                                    ...
                                    <div class="w-full relative group flex flex-col gap-1 ">
                                        <label for="countries_visited_last_10_years" class="font-semibold text-ternary/90 text-sm">Countries Visited in Last 1 Years</label>
                                        <div class="w-full relative">
                  ...
                  <div class="bg-white rounded-xl shadow-md overflow-hidden section-container" data-section="profession">
                    ...
                    @endphp
                        ...
                        @if(in_array('Occupation', $permission))
                             <!-- present Occupation -->
                                 <div class="w-full relative group flex flex-col gap-1">
                                        <label for="present_occupation" class="font-semibold text-ternary/90 text-sm">Current  Occupation</label>
                                        <div class="w-full relative">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                   @if(in_array('Spouse’s Full Name', $permission))
                                                        <div class="w-full">
                                                        <label for="spouse_name" class="font-semibold text-ternary/90 text-sm">Husband / Wife Full Name</label>
                                                        ...
                                                        <div class="w-full">
                                                        <label for="spouse_birth_place" class="font-semibold text-ternary/90 text-sm">Country of Birth</label>
    ...
    @endif
                    ...
                    @if(in_array('Children Section', $permission))
                                                                        ...
                                                                        <div class="child-fields border p-4 mb-4 rounded-[3px] rounded-tr-[8px] border-secondary/40 bg-white shadow-sm relative bg-black/10 shadow-lg shadow-black/10">
                                                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-6">
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <input type="date" max="9999-12-31" name="child_dob[]" value="{{ $child->dob }}" class="w-full pl-2 pr-2 py-1 border rounded-[3px] border-secondary/40 focus:outline-none focus:border-secondary/70 transition ease-in duration-200">
                                                                                </div>
                                                ...
                                                <div class="w-full relative group flex flex-col gap-1 col-span-2 mb-4">
                                                    <label for="relative_information" class="font-semibold text-ternary/90 text-sm">
                                                        Relative Information
                                                    </label>
                                                    <div class="w-full relative">
                                                        <textarea name="relative_information" id="relative_information"
                                                            ...
                                                            transition ease-in duration-200 overflow-hidden resize-none">{{ old('relative_information', $bookingData->clint->clientinfo->relative_information ?? '') }}</textarea>
                                                        <i class="fa fa-info-circle absolute right-3 top-4 text-sm text-secondary/80 pointer-events-none"></i>
                                                    </div>
                                                </div>
                                            @endif
                                                            <!-- Add More Button -->
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden section-container" data-section="travel">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div class="w-full relative group flex flex-col gap-1">
                                            <label for="expecteddate" class="font-semibold text-ternary/90 text-sm">Expected Date of arrival *</label>
                                            <div class="w-full relative">
