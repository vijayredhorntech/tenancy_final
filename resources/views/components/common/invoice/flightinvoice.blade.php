<div class="w-full border-[1px] border-t-[4px] border-ternary/20 border-t-primary bg-white flex gap-2 flex-col shadow-lg shadow-gray-300">
        ...
        <div class="bg-white shadow-md shadow-ternary/20 border-[2px] border-ternary/30 rounded-lg px-16 w-[772px] py-12" id="invoiceContainer">
            ...
            $passenger_deatils=$booking->flightBooking->passengersdetails; 
            ...
            $agency_address=$booking->agency->details;
            $details = json_decode($booking->flightBooking->details, true);
            $flight_search = json_decode($booking->flightBooking->flightSearch, true);
