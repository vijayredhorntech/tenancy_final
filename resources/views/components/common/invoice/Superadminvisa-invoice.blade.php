...
<head>
    ...
    <style>
        ...
        /* Footer styles - only visible on last page */
        .footer {
            height: 10vh;
            width: 100%;
            max-width: 768px;
        ...
        @media print {
            ...
            /* Footer positioning for print - only on last page */
            .footer {
                display: block;
                position: absolute;
                bottom: 0;
            ...
            .invoice-container {
                padding-bottom: 15vh; /* Space for footer on last page */
            }
        }
        ...
        /* Special class for last page content */
        .last-page-content {
            position: relative;
