...
{{--        === heading section code ends here===--}}
       ...
       @if(isset($booking->paymenthistory) && isset($booking->paymenthistory[0]->payment_status) && $booking->paymenthistory[0]->payment_status == '1')
       
       <div class="bg-success/10 px-4 py-2 border-b-[2px] border-b-success/20 flex justify-between">
            <span class="font-semibold text-ternary text-xl">  Payment is Done</span>
       ...
       <div id="formDiv" class="w-full border-b-[2px] border-b-ternary/10 shadow-lg shadow-ternary/20 ">
            <form action="{{ route('agencypay.invoice.ammount') }}" method="POST" enctype="multipart/form-data">
                @csrf
