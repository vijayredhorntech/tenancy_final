...
{{--        === this is code for heading section ===--}}
        ...
        <div class="bg-primary/10 px-4 py-2 border-b-[2px] border-b-primary/20 flex justify-between">
            ...
            <span class="font-semibold text-ternary text-xl">Amount £ {{ isset($booking->paymenthistory) && isset($booking->paymenthistory[0]->balance) ? $booking->paymenthistory[0]->balance : $booking['amount'] }}
...
{{--        === heading section code ends here===--}}
       ...
       @if(isset($booking) && isset($booking->invoicestatus) && $booking->invoicestatus == '1')
    
       @if($booking->cancelinvoice->status==0)
   
       <div class="bg-success/10 px-4 py-2 border-b-[2px] border-b-success/20 flex justify-between">
            <span class="font-semibold text-ternary text-xl">  Request is going to admin</span>
       ...
       <div id="formDiv" class="w-full border-b-[2px] border-b-ternary/10 shadow-lg shadow-ternary/20 ">
            <form action="{{ route('agencypay.invoice.cancel') }}" method="POST" enctype="multipart/form-data"  onsubmit="return confirmCancel()">
                @csrf
              ...
              @endif
                ...
                <div class="w-full relative group flex flex-col gap-1">
                     ...
                     <div class="w-full relative group flex flex-col gap-1 paymentdata ">
                         ...
                         <div class="w-full relative">
                             <textarea   name="remark" id="remark" rows="2" placeholder="Description....." class="w-full pl-2 pr-8 py-1 rounded-[3px] rounded-tr-[8px] border-[1px] border-b-[2px] border-r-[2px] border-secondary/40 focus:outline-none focus:ring-0 focus:border-secondary/70 placeholder-ternary/70 transition ease-in duration-2000"></textarea>
