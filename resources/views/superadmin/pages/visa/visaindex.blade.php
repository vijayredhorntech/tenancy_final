                    ...
                    @csrf
                     <div class="w-full grid xl:grid-cols-4 gap-2 px-4 py-6">
                         ...
                         <div class="w-full relative group flex flex-col gap-1">
                             ...
                             <div class="w-full relative">
                                 <textarea   name="description" id="description" rows="1" placeholder="Description....." class="w-full pl-2 pr-8 py-1 rounded-[3px] rounded-tr-[8px] border-[1px] border-b-[2px] border-r-[2px] border-secondary/40 focus:outline-none focus:ring-0 focus:border-secondary/70 placeholder-ternary/70 transition ease-in duration-2000"></textarea>
            ...
            <div class="w-full overflow-x-auto p-4">
                ...
                <table class="w-full border-[2px] border-secondary/40 border-collapse mt-4">
                    <tr>
                        ...
                        <td class="border-[2px] border-secondary/40 bg-gray-100 px-4 py-1.5 text-ternary/80 font-bold text-md">Visa name</td>
