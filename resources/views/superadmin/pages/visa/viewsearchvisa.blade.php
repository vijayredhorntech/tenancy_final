...
<div class="text-sm breadcrumbs">
    <ul>
        ...
        <li><a>India visa for Singapore passport holder living in United <Kingdom class=""></Kingdom></a></li>
    </ul>
</div>
@if(!$visas->isEmpty())
...
<div class="w-full  flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-col sm:flex-col flex-col mt-10 ">
 ...
 <div class="2xl:w-1/5 xl:w-1/5 lg:w-1/5 md:w-full sm:w-full w-full h-max flex flex-wrap border-2 border-gray-200">
 ...
 @forelse($visas as $visa)
  ...
  <div class="tabdata 2xl:w-4/5 xl:w-4/5 lg:w-4/5 md:w-full sm:w-full w-full 
      2xl:mt-0 xl:mt-0 lg:mt-0 md:mt-4 sm:mt-4 mt-4 px-5 py-3 border-2 border-gray-200 
      ...
      <div class=" px-5 py-9 flex flex-col bg-gray-200 rounded-md mt-4 ">
          <span class="m-auto text-gray-700 2xl:text-2xl xl:text-2xl lg:text-2xl md:text-2xl sm:text-xl text-lg">Fill out India tourist e-visa application form online </span>
          <a href="{{route('visa.payment',['id'=>$visa->id])}}" class="m-auto text-white bg-red-600 py-3 px-10 mt-4 text-xl font-semibold rounded-md">GET STARTED</a>
          ...
          <span class="m-auto text-gray-700 2xl:text-2xl xl:text-2xl lg:text-2xl md:text-2xl sm:text-xl text-lg mt-4">and provide digital copies of the following documents:</span>
      </div>
      ...
      <div class="2xl:flex xl:flex lg:flex md:flex sm:hidden hidden flex-col">
        <div class="flex justify-between px-3 font-semibold text-black text-lg mt-10">
