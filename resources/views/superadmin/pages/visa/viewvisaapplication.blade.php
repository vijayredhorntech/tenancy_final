        ...
        <div class="w-full overflow-x-auto p-4">
                ...
                @if($clientData->sendtoadmin == 3)  
                    ...
                    <a href="{{ route('application.fill', [
                            'type' => 'agencies', 
                            'id'   => $clientData->id, 
                            'token'=> $clientData->agency->agencytoken ?? ''
                        ]) }}">
                        <div class="w-max font-semibold text-ternary border-b-[2px] border-ternary/60 text-lg px-8 py-0.5 hover:bg-secondary/40 hover:border-secondary/60 transition ease-in duration-200 cursor-pointer flex items-center gap-2">
                            <i class="fas fa-file-alt"></i>
                            Fill Application
                        </div>
                    </a>
