...
{{--        === this is code for table section ===--}}
            <div class="w-full overflow-x-auto p-4">
                     <!-- search function  -->
                     <form id="filter-form" method="GET" action="{{ route('superadminhotel.booking') }}" class="space-y-4">
                                ...
                                <div class="flex justify-between items-center mt-4">
                                    <div class="flex gap-2">
                                        ...
                                        <a href="{{ route('superadminhotel.booking') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">
                                            Clear Filters
                                        </a>
                                    </div>
