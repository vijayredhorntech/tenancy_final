<x-front.layout>
    ...
    @php
        $activeCount = isset($agencies) ? $agencies->filter(fn($a) => $a->details->status != '0')->count() : 0;
        $inactiveCount = isset($agencies) ? $agencies->filter(fn($a) => $a->details->status == '0')->count() : 0;
   @endphp

    <div class="w-full grid xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-2 mb-4">
            ...
            <div class="w-full border-[1px] border-t-[4px] border-ternary/20 border-t-primary bg-white flex gap-2 items-center justify-between p-4">
                <div class="flex flex-col gap-2">
                        <span class="font-semibold text-ternary/70 text-md">Total Client </span>
                        <span class="font-bold text-2xl text-ternary"> {{ $agencies->count() }}</span>
                </div>
                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" height="60"
                        ...
                        <path
                            ...
                            transform="translate(-180.86417 -106.46046)" fill="#ff4216"/>
            ...
            <div class="w-full border-[1px] border-t-[4px] border-ternary/20 border-t-secondary bg-white flex gap-2 items-center justify-between p-4">
                <div class="flex flex-col gap-2">
                    <span class="font-semibold text-ternary/70 text-md">Active Client</span>
                    <span class="font-bold text-2xl text-ternary"> {{$activeCount}}</span>
                </div>
            ...
            <div class="w-full border-[1px] border-t-[4px] border-ternary/20 border-t-success bg-white flex gap-2 items-center justify-between p-4">
                <div class="flex flex-col gap-2">
                    <span class="font-semibold text-ternary/70 text-md">Inactive Client</span>
    
                    <span class="font-bold text-2xl text-ternary">{{$inactiveCount}}</span>
                </div>
    ...
    <div
        ...
        <div class="w-full overflow-x-auto p-4">
            <!-- search function  -->
        <form id="filter-form" method="GET" action="{{ route('agency') }}" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <!-- Amount Range -->
                <div>
                    <label for="amount_min" class="block text-sm font-medium text-gray-700">Amount Range (£)</label>
                ...
                <div>
                    <label for="payment_method" class="block text-sm font-medium text-gray-700">Service</label>
                    <select name="service_id" id="service_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primaryDark focus:ring-primaryDark sm:text-sm">
            ...
            <div class="flex justify-between items-center mt-4">
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('agency') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">
                        Clear Filters
                    </a>
                </div>
                <div class="flex gap-2 items-center">
                    ...
                    <a href="{{ route('agencies.downloade') }}?{{ http_build_query(request()->all()) }}" 
                       class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700">
                        Export CSV
                    </a>
                    <a href="{{ route('agencies.invoice', request()->query()) }}"
