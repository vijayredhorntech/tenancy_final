            ...
            <table class="w-full border-[2px] border-secondary/40 border-collapse mt-4">
                ...
                @forelse($agencies as $agency)
                    <tr class="{{$loop->iteration%2===0?'bg-gray-100/40':''}} hover:bg-secondary/10 cursor-pointer transition ease-in duration-2000">
                        ...
                        <td class="border-[2px] border-secondary/40  px-4 py-1 text-ternary/80 font-medium text-sm">
                            <div class="flex justify-between gap-2">
                                ...
                                <a href="" title="Add Funds">
                                    <div
                                        class=" bg-success/10 text-success h-6 w-6 flex justify-center items-center rounded-[3px] hover:bg-success hover:text-white transition ease-in duration-2000">
                        ...
                        <td class="border-[2px] border-secondary/40  px-4 py-1 text-ternary/80 font-medium text-sm">
                            <span
                                class="bg-{{$agency['status']==='Inactive'?'danger':'success'}}/10 text-{{$agency['status']==='Inactive'?'danger':'success'}} px-2 py-1 rounded-[3px] font-bold">{{$agency['status']}}</span>
                        </td>
                        <td class="border-[2px] border-secondary/40  px-4 py-1 text-ternary/80 font-medium text-sm">
