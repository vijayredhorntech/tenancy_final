                ...
                @endif
                     <div class="w-full grid xl:grid-cols-4 gap-2 px-4 py-6">
                         ...
                         <div class="w-full relative group flex flex-col gap-1">
                             ...
                             <div class="w-full relative">
                                 <input type="text" name="contact_name" id="contact_name" placeholder="Contact Person Name....." class="w-full pl-2 pr-8 py-1 rounded-[3px] rounded-tr-[8px] border-[1px] border-b-[2px] border-r-[2px] border-secondary/40 focus:outline-none focus:ring-0 focus:border-secondary/70 placeholder-ternary/70 transition ease-in duration-2000">
                                 <i class="fa fa-user absolute right-3 top-[50%] translate-y-[-50%] text-sm text-secondary/80"></i>
                             </div>
                         </div>
                         ...
                         <div class="w-full relative group flex flex-col gap-1">
                             ...
                             <div class="w-full relative">
                                 <input type="number" name="contact_phone" id="contact_phone" placeholder="Contact Phone....." class="w-full pl-2 pr-8 py-1 rounded-[3px] rounded-tr-[8px] border-[1px] border-b-[2px] border-r-[2px] border-secondary/40 focus:outline-none focus:ring-0 focus:border-secondary/70 placeholder-ternary/70 transition ease-in duration-2000">
                                 <i class="fa fa-phone absolute right-3 top-[50%] translate-y-[-50%] text-sm text-secondary/80"></i>
                             </div>
                         </div>
                         ...
                         <div class="w-full relative group flex flex-col gap-1">
                             ...
                             <div class="w-full relative">
                                 <input type="text" name="domain_name" id="domain_name" placeholder="Domain....." class="w-full pl-2 pr-8 py-1 rounded-[3px] rounded-tr-[8px] border-[1px] border-b-[2px] border-r-[2px] border-secondary/40 focus:outline-none focus:ring-0 focus:border-secondary/70 placeholder-ternary/70 transition ease-in duration-2000">
                         ...
                         <div class="w-full relative group flex flex-col gap-1">
                             ...
                             <div class="w-full relative">
                                 <input type="text" name="database_name" id="database_name" placeholder="Phone....." class="w-full pl-2 pr-8 py-1 rounded-[3px] rounded-tr-[8px] border-[1px] border-b-[2px] border-r-[2px] border-secondary/40 focus:outline-none focus:ring-0 focus:border-secondary/70 placeholder-ternary/70 transition ease-in duration-2000">
                         ...
                         <label class="font-semibold text-ternary/90 text-sm">Select Services</label>
                            ...
                            @forelse($services as $service)   
                                <div class="flex items-center gap-2">
                                    <input type="checkbox" id="service_{{ $service->id }}" name="services[]" value="{{ $service->id }}" class="accent-secondary w-4 h-4">
                                    <label for="service_{{ $service->id }}" class="text-sm text-ternary/80 cursor-pointer">{{ $service->name }}</label>
                                </div>
                            @empty
            ...
            <div class="w-full overflow-x-auto p-4">
                ...
                <table class="w-full border-[2px] border-secondary/40 border-collapse mt-4">
                    <tr>
                        ...
                        <td class="border-[2px] border-secondary/40 bg-gray-100 px-4 py-1.5 text-ternary/80 font-bold text-md">Site url</td>
                    ...
                    @forelse($agencies as $agency)
                        <tr class="{{$loop->iteration%2===0?'bg-gray-100/40':''}} hover:bg-secondary/10 cursor-pointer transition ease-in duration-2000" >
                            ...
                            <td class="border-[2px] border-secondary/40  px-4 py-1 text-ternary/80 font-medium text-sm">{{$agency['created_at']}}</td>
                            ...
                            <td class="border-[2px] border-secondary/40  px-4 py-1 text-ternary/80 font-medium text-sm">{{$agency->domains->full_url}}</td>
                            <td class="border-[2px] border-secondary/40  px-4 py-1 text-ternary/80 font-medium text-sm">
                            ...
                            <td class="border-[2px] border-secondary/40  px-4 py-1 text-ternary/80 font-medium text-sm"> {{$agency['fund_remaining']}}</td>
                            <td class="border-[2px] border-secondary/40  px-4 py-1 text-ternary/80 font-medium text-sm">
