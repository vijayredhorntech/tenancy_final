<x-front.layout>
    ...
    @endsection
      ...
      <!-- Notification Div -->
      <div class="w-full bg-red-600 text-white py-2 px-4 mb-4 rounded-md shadow-md">
      @foreach($pending_booking as $key => $value)
        ...
        <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <span class="font-semibold">{{ $value->invoice_number }}</span>
                    <span class="ml-2">{{ $value->service_name->name }}</span>
        ...
        <a href="{{route('agency')}}">
            <div class="w-full border-[1px] border-t-[4px] border-ternary/20 border-t-primary bg-white flex gap-2 items-center justify-between p-4">
                <div class="flex flex-col gap-2">
                        <span class="font-semibold text-ternary/70 text-md">Total Client Agency</span>
      ...
      <a href="">
        ...
        <div class="w-full grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-3 grid-cols-1 gap-2 mt-6">
            ...
            <div class="w-full border-[1px] border-t-[4px] border-ternary/20 border-t-warning bg-white flex gap-2 flex-col xl:col-span-4 lg:col-span-3 md:col-span-2 sm:col-span-2">
                ...
                <div class="w-full overflow-x-auto p-4">
                    <div id="agencyBookingDayChart"></div>
                </div>
            </div>
                    ...
                    <table class="w-full border-[1px] border-secondary/30 border-collapse">
                        ...
                        @forelse($funds as $fund)
                            ...
                            <tr>
                                ...
                                <td class="border-[1px] border-secondary/50  px-4 py-1 text-ternary/80 font-medium text-sm">
                                <a href="{{ route('superadmingenerateInvoice', ['invoice_number' => $fund['invoice_number'] ?? '']) }}">  {{ $fund['invoice_number'] }}
                                  </a> 
                                </td>
