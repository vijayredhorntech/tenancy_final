...
{{--        === this is code for table section ===--}}
            <div class="w-full overflow-x-auto p-4">
                     <!-- search function  -->
         <form id="filter-form" method="GET" action="{{ route('agency.staff.attandance') }}" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('agency.staff.attandance') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">
                            Clear Filters
                        </a>
                    </div>
                        ...
                        <tr class="{{$loop->iteration%2===0?'bg-gray-100/40':''}} hover:bg-secondary/10 cursor-pointer transition ease-in duration-2000" >
                            ...
                            <td class="border-[2px] border-secondary/40  px-4 py-1 text-ternary/80 font-medium text-sm"> 
                                   @php
                                    ...
                                    <a href="{{ route('agency.single.attendance', ['id' => $user->id]) }}?{{ $query }}" title="View Dashboard">
