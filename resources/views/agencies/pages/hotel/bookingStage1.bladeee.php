...
<div class="lg:w-3/4 md:w-3/4 sm:w-full w-full h-max m-auto bg-sky-100 shadow">
    ...
    <div class="w-full flex lg:flex-row md:flex-row sm:flex-row flex-col h-max m-auto mt-10 border-2 ">
        ...
        <div class="lg:w-full w-full h-max bg-sky-100">
            ...
            <span class="float-right text-base mr-2 hover:text-black hover:font-semibold">
...
<!--                                            {{ $hotelMoreDetails['StarRating'] }}</span>-->
                ...
                <div class="w-full ml-2 justify-between bg-white p-2">
                    ...
                    <div class="flex flex-col ml-2">
                        ...
                        <span class="text-black font-semibold text-base mt-4">Status : <span
                            class="text-green-500 font-semibold text-sm md:text-base">Available</span>
                        </span>
            ...
            <x-splade-form method="POST" :action="route('hotel.bookingStage2')">
                ...
                <div class="w-[98%] ml-[11px] px-6 border-2 border-t-gray-300 border-b-gray-300 py-4">
                    ...
                    <ol>
                        ...
                        @if (isset($bookingDetails['fetchPolicies']['Response']['Body']['Policies']['Policy']))
                            ...
                            @if ($data[0])
                                {{-- @dd($data) --}}
                                {{-- @dd($bookingDetails['fetchPolicies']['Response']['Body']) --}}
                                @foreach ($data as $record)
                                    {{-- @php
                              if(!is_array($record))
                              $record = makeArrayWithIndex($record);   //calling helper function to make 0 index
                                dd($record);
                              @endphp --}}
                                    <ol>
