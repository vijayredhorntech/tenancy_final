    ...
    <form action="{{ route('updateclient.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="border-b pb-4 mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="name" class="w-full p-2 border rounded-lg" 
                           placeholder="Enter First Name" value="{{ $client->name ?? 'N/A' }}">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="text" name="last" class="w-full p-2 border rounded-lg" 
                           placeholder="Enter Last Name" value="{{$client->clientinfo->last_name ?? ''}}">
                    @error('last')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="dob" class="w-full p-2 border rounded-lg" value="{{$client->clientinfo->dob ?? ''}}">
                    @error('dob')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nationality" class="w-full p-2 border rounded-lg" 
                           placeholder="Enter nationality" value="{{$client->clientinfo->nationality ?? ''}}">
                    @error('nationality')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <input type="number" name="passport_number" value="{{$client->passport_number ?? ''}}" class="w-full p-2 border rounded-lg">
                ...
                <input type="date" name="passport_issue_date" value="{{$client->clientinfo->passport_issue_date ?? ''}}"  class="w-full p-2 border rounded-lg">
            ...
            <div>
                ...
                <input type="date" name="passport_expiry_date" value="{{$client->clientinfo->passport_expiry_date ?? ''}}" class="w-full p-2 border rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="email" name="email" class="w-full p-2 border rounded-lg" 
                           placeholder="Enter email" value="{{$client->email ?? 'N/A'}}">
                    @error('email')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" class="w-full p-2 border rounded-lg" 
                           placeholder="Enter phone number" value="{{$client->phone_number ?? 'N/A'}}">
                    @error('phone')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="border-b pb-4 mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="father_name" class="w-full p-2 border rounded-lg" value="{{$client->clientinfo->father_name ?? ''}}">
                    @error('father_name')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="mother_name" class="w-full p-2 border rounded-lg" value="{{$client->clientinfo->mother_name ?? ''}}">
                    @error('mother_name')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
