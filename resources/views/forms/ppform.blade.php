...
<body>
 ...
 <div class="header-row" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px;">
  ...
  <div class="form-group">
    <label class="label">1. Full name (Initials not allowed):<input type="text" name="fullname" style="width: 450px;" ></label><br>
    <input type="text" name="fullname" style="width: 670px;">
  </div>

  <div class="form-group">
    <label class="label">2. Sex:Male/Female/Others</label><input type="Text"  value="" style="width: 150px;">
  </div>

  <div class="form-group section">
    (a) Has the applicant ever changed name? <br>
    (b) If yes, previous name: <input type="text" name="prevname" style="width: 500px;">
  </div>

  <div class="form-group">
     4. Date of Birth:
    <input type="Text" value="" style="width:220px;">&nbsp;5. Place of Birth:
    <input type="text" value="" style="width: 220px;">
  </div>

  <div class="form-group">
    <label>6. Profession:</label>
    <input type="text" name="profession" style="width: 570px;">
  </div>

  <div class="form-group">
    <label>7. a) Father:</label>
     <input type="text" name="" style="width: 580px;"><br>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; (Surname) <span style="margin-left: 150px;"> (Name)</span>         
  </div>

  <div class="form-group">
    <label>b) Mother:</label>
     <input type="text" name="" style="width: 590px;"><br>
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; (Surname)<span style="margin-left: 150px;"> (Name) </span>
  </div>

  <div class="form-group">
    <label>c) Husband / Wife:</label>
     <input type="text" name="" style="width: 530px;"><br>
       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;(Surname) <span style="margin-left: 150px;">(Name)</span>
  </div>
  ...
  <div class="form-group">
   ...
   <span style="margin-left: 30px;"></span> <input type="text" value="" style="width: 250px;"><span style="margin-left: 120px;"></span>
    <input type="text"value="" style="width: 250px;"><br>
     <span style="margin-left: 30px;"></span> <input type="text" value="" style="width: 250px;"><span style="margin-left: 120px;"></span>
    <input type="text"value="" style="width: 250px;"><br>
     <span style="margin-left: 30px;"></span> <input type="text" value="" style="width: 250px;"><span style="margin-left: 120px;"></span>
...
<div class="container">
  ...
  <div class="form-group">
    ...
    <input type="text" name="passport_no" style="width: 110px; margin-right: 30px;">
    (ii) Date & Place of issue:
    <input type="text" name="passport_issue" style="width: 110px;">
  </div>
