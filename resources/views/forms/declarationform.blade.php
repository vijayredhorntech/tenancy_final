...
<body>
  ...
  <div class="container">
    ...
    <div class="content">
      <p>
        I <input type="text" class="wide-input" value="{{ $applicantName }}"> hereby declare that I am present in the UK on the date <br>
    ...
    <div class="signature">
      <div class="signature-row">
        <label>PLACE & DATE:<input type="text" style="width: 40%;" value="{{ $city }}, {{ date('d/m/Y') }}"></label>
        <label>Signature of the Applicant:<input type="text" style="width: 30%;" value="{{ $applicantName }}"></label>
      </div>
    </div>
  </div>
