    ...
    <div class="form-container" id="form-to-export">
        ...
        <div class="section">
            <div class="field">
               ...
               <input type="text" name="full_name" class="editable" value="&nbsp; &nbsp; &nbsp; &nbsp;{{ $clientData->clint->client_name ?? '' }}">
            </div>
            ...
            <div class="field">
                ...
                <div class="checkbox-group">
                    <input type="checkbox" id="male" name="gender" value="Male" 
                        {{ isset($clientData->clint->gender) && $clientData->clint->gender == 'MALE' ? 'checked' : '' }}>
                    <label for="male">Male</label>
                </div>
                <div class="checkbox-group">
                    <input type="checkbox" id="female" name="gender" value="Female" 
                        {{ isset($clientData->clint->gender) && $clientData->clint->gender == 'FEMALE' ? 'checked' : '' }}>
                    <label for="female">Female</label>
                </div>
                <div class="checkbox-group">
                    <input type="checkbox" id="other" name="gender" value="Other" 
                        {{ isset($clientData->clint->gender) && $clientData->clint->gender == 'OTHER' ? 'checked' : '' }}>
                    <label for="other">Others</label>
                </div>
                @if(empty($clientData->clint->gender))
            ...
            <div class="field">
              ...
              {{-- <input type="text" name="name_changed" class="editable" value="&nbsp; &nbsp; &nbsp;&nbsp;{{ $clientData->clint->clientinfo->previous_name ?? '' }}" test="Yes/No">--}} 
              <input type="text" name="name_changed" class="editable"
                     value="&nbsp; &nbsp; &nbsp;&nbsp;{{ !empty($clientData->clint->clientinfo->previous_name) ? 'Yes' : 'No' }}">
            ...
            <div class="field">
                4. Date of Birth: 
                <input type="text" name="dob" class="editable" test="DD/MM/YYYY" value="&nbsp; &nbsp; &nbsp;&nbsp;{{ $clientData->clint->date_of_birth ?? '' }}">
                
                5. Place of Birth: 
                <input type="text" name="birth_place" class="editable" value="&nbsp; &nbsp; &nbsp;&nbsp;{{ $clientData->clint->clientinfo->place_of_birth ?? '' }}">
            </div>
            ...
            <div class="columns">
                <div class="column">
                    <div class="field">
                        ...
                        <textarea name="permanent_address" class="editable" test="Enter permanent address">&nbsp; &nbsp; &nbsp;&nbsp;{{ $clientData->clint->permanent_address ?? '' }}</textarea>
                    </div>
                </div>
                <div class="column">
                    <div class="field">
                        8(b) Present Residential Address & Tel. No.<br>
                        <textarea name="present_address" class="editable" test="Enter present address">&nbsp; &nbsp; &nbsp;&nbsp;{{ $clientData->clint->permanent_address ?? '' }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            <div class="field">
                ...
                <input type="text" name="passport_number" class="editable" value="&nbsp;&nbsp;&nbsp;&nbsp;{{ $clientData->clint->clientinfo->passport_ic_number ?? '' }}" test="Passport number">
                <br>
